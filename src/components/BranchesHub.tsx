  ...
  return (
    <div className="grid lg:grid-cols-12 gap-8 items-start">
      ...
      <div className="lg:col-span-7 space-y-6">
        ...
        <div className="glass-panel p-6 rounded-3xl border border-slate-200 bg-white space-y-4 backdrop-blur-xl">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 pl-12 pr-4 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-brand/50 transition-all text-sm"
            />
          </div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 py-3 px-4 rounded-xl text-xs sm:text-sm font-bold transition-all ${
                regionFilter === 'all' 
                  ? 'bg-brand text-white shadow-[0_0_15px_rgba(16,185,129,0.2)]' 
        ...
        <div className="grid sm:grid-cols-2 gap-4 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
          {filteredBranches.length > 0 ? (
              ...
              return (
                <div
                  ...
                  className={`glass-panel p-5 rounded-2xl border transition-all duration-300 cursor-pointer relative overflow-hidden group ${
                    isSelected 
                      ? 'border-brand bg-emerald-50/15 shadow-[0_0_20px_rgba(16,185,129,0.06)]' 
                      : 'border-slate-200/80 bg-white hover:border-brand/40 hover:bg-slate-50/60'
                  }`}
                >
                    ...
                    <div className="flex items-center gap-3">
                      <div className={`w-10 h-10 rounded-xl flex items-center justify-center border transition-all ${
                        isSelected 
                          ...
                          : 'bg-slate-100 border-slate-200/50 text-slate-600 group-hover:text-brand group-hover:border-brand/20'
                      }`}>
                      ...
                      <div>
                        ...
                        <h4 className="font-bold text-slate-900 text-base leading-tight group-hover:text-brand transition-colors">
                          {branch.district}
                        </h4>
                      </div>
                    </div>
                    
                    <div className="flex items-center gap-1.5 bg-emerald-500/10 text-emerald-600 text-[10px] font-black px-2 py-1 rounded-full border border-emerald-500/20">
                  ...
                  <div className="flex gap-2">
                    <a
                      ...
                      className="flex-1 flex items-center justify-center gap-1.5 bg-slate-100 border border-slate-200 hover:bg-brand hover:border-brand hover:text-white text-slate-800 py-2 rounded-lg text-xs font-bold transition-all"
                    ...
                    <a
                      ...
                      className="flex items-center justify-center w-9 h-9 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg border border-slate-200 transition-colors"
            ...
            <div className="col-span-2 glass-panel p-12 text-center border border-slate-200 rounded-3xl bg-white">
              <ShieldAlert className="w-12 h-12 text-slate-400 mx-auto mb-4" />
              <h4 className="text-slate-900 font-bold text-lg mb-2">Şube Bulunamadı</h4>
      ...
      <div className="lg:col-span-5 lg:sticky lg:top-36 space-y-6">
        <div className="glass-panel rounded-3xl border border-slate-200 bg-white backdrop-blur-2xl overflow-hidden shadow-2xl">
          ...
          <div className="p-5 border-b border-slate-100 bg-slate-50 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h4 className="text-slate-900 font-bold text-sm leading-none">Hizmet Noktası Detayları</h4>
                <span className="text-[10px] text-slate-500 font-medium">Aktif Şube Haritası</span>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <Activity className="w-4 h-4 text-emerald-600 animate-pulse" />
              <span className="text-[10px] text-emerald-600 font-extrabold uppercase tracking-wider">Hattı Çevrimiçi</span>
            </div>
          </div>

          {/* Interactive Map Embed */}
          <div className="h-[320px] w-full bg-slate-100 relative border-b border-slate-200">
            <iframe
              src={selectedBranch 
          ...
          <div className="p-6 space-y-6 bg-slate-50/50">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white border border-slate-200 p-4 rounded-2xl flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-sm font-black text-slate-900">35-45 Dakika</span>
                </div>
              </div>
              ...
              <div className="bg-white border border-slate-200 p-4 rounded-2xl flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-sm font-black text-slate-900">3 Aktif Mobil</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 flex items-center justify-center gap-2 bg-brand hover:bg-brand-hover text-white py-3.5 rounded-xl text-sm font-bold transition-all shadow-lg shadow-brand/10"
              >
              ...
              <a
                href="tel:+905016355053"
                className="flex items-center justify-center w-12 h-12 bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-700 rounded-xl transition-all"
              >
